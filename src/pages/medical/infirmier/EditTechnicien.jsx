...
const EditTechnicien = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let errorMessage = "Erreur lors de la mise à jour du technicien";
      ...
      if (errorMessage.toLowerCase().includes('existe déjà')) {
        Swal.fire({
          ...
          html: `L'email <b>${formData.email}</b> est déjà associé à un autre technicien.`,
          confirmButtonText: 'OK'
        });
      } 
    ...
    <div className="wrapper">
      ...
      <div className="content-wrapper">
        <div className="content-header">
          <h1 className="m-0">Modifier le Technicien</h1>
        </div>
