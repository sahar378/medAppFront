...
const ActiveMedicaments = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const produitsData = await authService.getActiveMedicaments();
    ...
    <div className="wrapper">
      ...
      <div className="content-wrapper">
        <div className="content-header">
          <h1 className="m-0">Stock Actif - Médicaments</h1>
        </div>
...
export default ActiveMedicaments;